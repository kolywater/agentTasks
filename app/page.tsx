...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gray-50">
      ...
      {/* Floating layout toggle — priority view only */}
      {view === "priority" && (
        <button
          onClick={toggleLayoutMode}
          className="fixed bottom-6 right-6 bg-white shadow-lg rounded-full p-3 text-gray-500 hover:text-gray-700 transition-all z-50"
